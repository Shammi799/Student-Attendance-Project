...
private string _outtime;
    ...
    public SqlDataReader Branch_check(string Branch_Name)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "Branch_check";
    ...
    public int CRM_attendance_insert(string Serial_no,string agent_name ,string Branch_Name, string att_name, string leave_name, string remarks, DateTime attendance_date, string intime, string outtime, char flag, string created_by)
    {
    ...
    public string crm_user_insert(clsUser objUser)
    {
        ...
        public SqlDataReader question_ans_status_check1()
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "question_ans_status_check1";
    ...
    public SqlDataReader question_ans_mail_status_update(string mobile_no, string personal_email)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "question_ans_mail_status_update";
        objCommand.Parameters.AddWithValue("@mobile_no", mobile_no);
        objCommand.Parameters.AddWithValue("@personal_email", personal_email);
        objCommand.Connection = objConnection;
        dataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection);
        objCommand.Dispose();
        objCommand = null;
    ...
    public SqlDataReader question_ans_status_check(string mobile_no, string personal_email)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "question_ans_status_check";
        objCommand.Parameters.AddWithValue("@mobile_no", mobile_no);
        objCommand.Parameters.AddWithValue("@personal_email", personal_email);
        objCommand.Connection = objConnection;
        dataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection);
    ...
    public SqlDataReader UspTblStudentSelectByID(string StudentID, string password)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "UspTblStudentSelectByID";
        objCommand.Parameters.AddWithValue("@StudentID", StudentID);
        objCommand.Parameters.AddWithValue("@Password", password);
      //  objCommand.Parameters.AddWithValue("@mac_address", mac_address);
        objCommand.Connection = objConnection;
        dataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection);
        objCommand.Dispose();
        objCommand = null;
    ...
    public SqlDataReader crm_user_ADMINlogin_checkMac(string mac_address)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "crm_user_ADMINlogin_checkMac";
        objCommand.Parameters.AddWithValue("@mac_address", mac_address);
        //objCommand.Parameters.AddWithValue("@password", password);
        objCommand.Connection = objConnection;
        dataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection);
    ...
    public string crm_user_ADMINlogin_Update_mac_address(string emp_code, string password, string mac_address)
    {
        using (SqlConnection objConnection = new SqlConnection(con_str))
        {
            ...
            objCommand.CommandType = CommandType.StoredProcedure;
            objCommand.CommandTimeout = 0;
            objCommand.CommandText = "crm_user_ADMINlogin_Update_mac_address ";
            objCommand.Parameters.AddWithValue("@password", password);
            objCommand.Parameters.AddWithValue("@emp_code", emp_code);
            objCommand.Parameters.AddWithValue("@mac_address", mac_address);
            dataReader = objCommand.ExecuteReader();
    ...
    public SqlDataReader crm_user_ADMINlogin_Imei(string mac_address)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "crm_user_ADMINlogin_Imei";
        objCommand.Parameters.AddWithValue("@mac_address", mac_address);
        //objCommand.Parameters.AddWithValue("@password", password);
        objCommand.Connection = objConnection;
        dataReader = objCommand.ExecuteReader(CommandBehavior.CloseConnection);
    ...
    public string crm_user_ADMINlogin_imei_update(string emp_code, string password, string mac_address)
    {
        using (SqlConnection objConnection = new SqlConnection(con_str))
        {
            ...
            objCommand.CommandType = CommandType.StoredProcedure;
            objCommand.CommandTimeout = 0;
            objCommand.CommandText = "crm_user_ADMINlogin_imei_update ";
            objCommand.Parameters.AddWithValue("@password", password);
            objCommand.Parameters.AddWithValue("@emp_code", emp_code);
            objCommand.Parameters.AddWithValue("@mac_address", mac_address);
            dataReader = objCommand.ExecuteReader();
    ...
    public SqlDataReader crm_user_ADMINlogin_ckeck(string emp_code, string password,string mac_address)
    {
        objConnection = new SqlConnection(con_str);
        objConnection.ConnectionString = con_str;
        objConnection.Open();
        ...
        objCommand.CommandType = CommandType.StoredProcedure;
        objCommand.CommandTimeout = 0;
        objCommand.CommandText = "crm_user_ADMINlogin";
        objCommand.Parameters.AddWithValue("@emp_code", emp_code);
        objCommand.Parameters.AddWithValue("@password", password);
        objCommand.Parameters.AddWithValue("@mac_address", mac_address);
        objCommand.Connection = objConnection;
